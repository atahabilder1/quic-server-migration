#!/usr/bin/env python3
"""Generate SHORT task summary as LaTeX PDF."""

import subprocess
import os
from datetime import date

OUTPUT_TEX = "ideas/RESEARCH_TASKS_SHORT.tex"
OUTPUT_PDF = "ideas/RESEARCH_TASKS_SHORT.pdf"
...
"""
    ...
    result = subprocess.run(
        ['pdflatex', '-interaction=nonstopmode', '-output-directory=ideas', OUTPUT_TEX],
    ...
    for ext in ['.aux', '.log', '.out']:
        path = OUTPUT_PDF.replace('.pdf', ext)
